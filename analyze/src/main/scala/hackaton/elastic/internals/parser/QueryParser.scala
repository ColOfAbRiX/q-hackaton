...
import hackaton.elastic.api.query.{
  BooleanQuery, ExistsQuery, MatchQuery, QueryDefinition, RangeQuery, RegexQuery, TermQuery, TermsQuery,
}
...
import com.sksamuel.elastic4s.requests.searches.queries.{
  BoolQuery => E4SBoolQuery, ExistsQuery => E4SExistsQuery, Query => E4SQuery, RangeQuery => E4SRangeQuery,
  RegexQuery => E4SRegexQuery,
}
